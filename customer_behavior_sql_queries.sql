...
select shipping_type, ROUND(AVG(purchase_amount),2) as "Average amount spent"
from customer
where shipping_type in ('Standard','Express')
group by shipping_type

--Q5. Do subscribed customers spend more? Compare average spends and total revenue between subscribers and non-subscribers
