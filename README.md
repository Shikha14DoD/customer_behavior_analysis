...
Dataset:
Retail customer shopping dataset Contains information such as:
...
Performed initial inspection and structure analysis
2. Data Cleaning
...
Designed a presentation using Gamma to communicate findings
